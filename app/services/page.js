export default function ServicesPage() {
  return (
    <div className={"text-sm"}>
      <h1 className="text-lime-400 font-bold mb-4">Nos services aux entrepreneurs</h1>
      <p className="mb-4">
        Lors d&apos;un entretien personnalisé, nous définissons et analysons ensemble vos critères de recherches (secteur d&apos;activité, périmètre géographique, type d&apos;entreprise, vos capacités financières…).
      </p>
      <p className="mb-4">
        Nous prenons soin de sélectionner les premiers dossiers sur la base de votre fiche descriptive et en adéquation avec votre expérience professionnelle&nbsp;et votre projet de reprise.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Après signature d&apos;un mandat de vente, nous préparons les supports nécessaires (fiche descriptive anonyme, dossier de présentation…) à la diffusion  de votre offre auprès d&apos;un large public qualifié, de manière à accroître sa visibilité sur le marché :
      </p>
      ...
      <h2 className={"text-medium text-lime-400 font-bold mb-4"}>L&apos;agence l&apos;Aventure Immobilière c&apos;est aussi :</h2>

      <ul className="list-disc ml-4 mb-4">
        <li>Un fichier de plus de 2000 clients et prospects.</li>
        <li>Plus de 300 affaires à vendre sur toute l&apos;Ile de France et Paris</li>
        <li>Un interlocuteur unique chargé de la vente de votre affaire et ayant une connaissance approfondie du marché</li>
        <li>Un compte rendu régulier sur les actions menées</li>
        <li>Aucun frais à payer (nos honoraires étant à la charge exclusive de l&apos;acquéreur)</li>
      </ul>


      <p className="font-semibold">
        Contactez-nous pour tous renseignements ou estimation par téléphone au 01.60.02.76.24 ou par mail : contact.ai@sfr.fr
      </p>
    </div>
  )
}
